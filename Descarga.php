...
<head>
    ...
    <title>Descarga de Excel | Asistencia INADEH</title>
    ...
    <div class="flex justify-center items-center min-h-screen">
        ...
        <div class="lg:w-2/5 md:w-full w-full m-auto">
            <form class="bg-white shadow rounded px-6 pt-8 mb-4 pb-8" style="width:92%;max-width:480px;margin:0 auto">
                <img class="w-1/5 mx-auto max-w-48 pb-4" src="img/participantes.png" alt="">
                <h4 class="mb-4 mt-2 text-xl font-bold">Descarga de Listados de Asistencia</h4>
