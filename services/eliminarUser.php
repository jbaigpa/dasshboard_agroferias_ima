...
$sqlCheckUser = "select * from admin_users c where md5(c.admin_id) = '$elid';";
...
if($numRows == 1){
    $sqlUpdateUser = "UPDATE admin_users SET  active=0 WHERE md5(admin_id)='$elid';";
	$actionLog = "disable_user";
	$actionRes = "disable_user_ok";
} 
