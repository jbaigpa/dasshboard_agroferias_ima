...
$sqlCheckUser = "select * from ".$tbl." c where md5(c.id) = '$elid';";
...
if($numRows == 1){
    $sqlUpdateUser = "UPDATE ".$tbl." SET  activo=1 WHERE md5(id)='$elid';";
	$actionLog = "renable_user";
} 

$nowdate = date('Y-m-d H:i:s');
if (mysqli_query($con, $sqlUpdateUser)) {
	$cedulaResponsable = $rowCheckUser['cedula_responsable'];
