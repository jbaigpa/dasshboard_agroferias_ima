...
#--- var_dump($_SESSION);
#-- $sqlGetParams = "SELECT * FROM `config` WHERE `active` = 1 and type != 'cientificweb'";
...
<head>
    ...
    <title>Parametros - IMA AGROFERIAS</title>
                                        ...
                                        <tbody>
                                            <?php while ($rowGetParams = mysqli_fetch_assoc($resGetParams)) { ?>
                                                <tr>
													...
													<td style="width: 5%;"><a href="editarParams.php?config=1&id=<?php echo $rowGetParams['config_id'] ?>"><i class="fa fa-edit" title="Editar"></i></a></td>
